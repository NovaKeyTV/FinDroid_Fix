...
class ExternalPlayerViewModel @Inject constructor(
    ...
    private val repository: JellyfinRepository, // Added repository
) : ViewModel() {
...
suspend fun launchExternalPlayerIfEnabled(
    ...
    externalPlayerLauncher: ActivityResultLauncher<Intent>, // Added launcher parameter
        ...
        try {
            ...
            if (startItem != null) {
                ...
                val intent = Intent(Intent.ACTION_VIEW).apply {
                    ...
                    // Added return reporting extras to match phone
                ...
                // Removed createChooser and FLAG_ACTIVITY_NEW_TASK so the launcher receives the result
