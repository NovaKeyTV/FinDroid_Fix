    ...
    withContext(Dispatchers.IO) {
        try {
            ...
            if (startItem != null) {
                ...
                // Detect installed player to set explicit component
                // Required for MX Player Pro on HTTP/HTTPS streams to return result
                ...
                val intent = Intent(Intent.ACTION_VIEW).apply {
                    ...
                    putExtra("secure_uri", true)                                    // missing before
                    putExtra("title", title)
                    putExtra("position", startItem.playbackPosition.toInt())        // Int for all players
                    ...
                    when {
                        ...
                        isVlc -> setClassName(vlcPackage, "$vlcPackage.StartActivity")  // was setPackage()
